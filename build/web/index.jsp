        ...
        <jsp:include page="Principal.jsp"></jsp:include>
            <div class="sweet-local" tabindex="-1" id="Ventana1" style="opacity: 1.03; display:none;">
                <div class="cont_reg">
                    ...
                    <div class="cont_form_user">
                        <p>Este sistema de información está diseñado para optimizar la consulta y gestión de los herramentales en los diversos procesos de la organización. Facilita el seguimiento de las actividades mediante alertas sobre pendientes relacionados con herramentales o maquinaria, asegurando que las <b style="color:#00281b">tareas necesarias</b> se realicen de manera <b style="color:#00281b">oportuna</b>. </br> El sistema como ayuda virtual, permite al usuario acceder a la información de manera <b style="color:#00281b">segura, rapida</b> y <b style="color:#00281b">confiable</b> para poder realizar en cada uno de los procesos del registro una adecuada manipulación.</p>
                    </div>
                </div>
            </div>
            ...
            <div id="main">
                <div class="img_logo" id="cont_img">
                    <img id="data_img" class="cls_img" src="Interfaz/Contenido/images/herramental.png" width="150">
                </div>
                <div>
                    <div class="cont_icon" onclick="mostrarConvencion(1)">
                        <i class="fas fa-question"></i>
                    </div>
                    <h1>HERRAMENTAL</h1><br>
...
<!--                    <script type='text/javascript'>
                    ...
                    <div style="float: right; bottom: 0;"><b style="font-size:15px; color:#03291d; ">VA</b><b style="font-size: 15px; color:#03291d"> 09.21.04</b><br></div>
