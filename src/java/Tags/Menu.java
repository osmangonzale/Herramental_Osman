...
//        }
        try {
            ...
            out.print("<nav class=\"navbar navbar-expand-lg main-navbar\">\n"
                    ...
                    + "            </div>\n"
                    + "          </li>\n"
                    + "          <li class=\"dropdown\"><a href=\"#\" data-toggle=\"dropdown\" style='color: #000000' class=\"nav-link dropdown-toggle nav-link-lg nav-link-user\">\n"
            ...
            out.print("<a style='color:#fff' href=\"Inicio.jsp\">Herramental</a>");
            out.print("</div>");
            out.print("<div class=\"sidebar-brand sidebar-brand-sm\">");
            out.print("<a style='color:#fff' href=\"Inicio.jsp\">HR</a>");
            out.print("</div>");

            out.print("<div class=\"mt-0 p-3 hide-sidebar-mini\">");
            out.print("<a style='color:black' href=\"Inicio.jsp\" class=\"btn btn-warning btn-lg btn-block btn-icon-split\">");
...
//            if (txtPermisos.contains("[81]")) {
                out.print("<li><a class=\"nav-link\" href=\"Herramental?opc=1\"><i style='margin-right:4px' class='fas fa-toolbox'></i>Herramental</a></li>");
//            } else {
//                cont++;
//            }
//            if (txtPermisos.contains("[82]")) {
                out.print("<li><a class=\"nav-link\" href=\"Tipo_maquina?opc=1\"><i style='margin-right:4px' class=\"fas fa-shield-alt\"></i>Tipo Maquina</a></li>");
//            } else {
//                cont++;
//            }
//            if (txtPermisos.contains("[83]")) {
                out.print("<li><a class=\"nav-link\" href=\"Clasificacion_defecto?opc=1\"><i style='margin-right:4px' class=\"fas fa-id-card-alt\"></i>Clasificacion Defecto</a></li>");
//            } else {
//                cont++;
//            }
//            if (txtPermisos.contains("[83]")) {
                out.print("<li><a class=\"nav-link\" href=\"Ficha_tecnica?opc=1\"><i style='margin-right:4px' class=\"fas fa-id-card-alt\"></i>Fichas Tecnicas de Proceso</a></li>");
//            } else {
//                cont++;
//            }
//            if (txtPermisos.contains("[83]")) {
                out.print("<li><a class=\"nav-link\" href=\"Roles?opc=1\"><i style='margin-right:4px' class=\"fas fa-id-card-alt\"></i>Roles</a></li>");
//            } else {
//                cont++;
//            }
//            if (txtPermisos.contains("[83]")) {
                out.print("<li><a class=\"nav-link\" href=\"Permisos?opc=1\"><i style='margin-right:4px' class=\"fas fa-id-card-alt\"></i>Permisos</a></li>");
//            } else {
//                cont++;
//            }
//            if (cont >= 4) {
...
//            }
            out.print("</ul>");
            out.print("</li>");
            out.print("<li class=\"menu-header\">Maquinas</li>");
            out.print("<li class=\"dropdown\">");
//            if (txtPermisos.contains("[86]")) {
                out.print("<a href='Maquina?opc=1' class='nav-link'><i class='fas fa-robot'></i> <span>Maquinas</span></a>");
//                out.print("<a href='Maquina?opc=1' class='nav-link'><i class='fas fa-cogs'></i> <span>Maquinas</span></a>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
            out.print("</li>");
            out.print("<li class=\"menu-header\">Procesos</li>");
            out.print("<li class=\"dropdown\">");
            out.print("<a  href=\"#\" class=\"nav-link has-dropdown\" data-toggle=\"dropdown\"><i class=\"fas fa-dolly-flatbed\"></i> <span>Programacion</span></a>");
            out.print("<ul class=\"dropdown-menu\">");
//            if (txtPermisos.contains("[84]")) {
                out.print("<li><a class=\"nav-link\" href='RecepcionMaterial?opc=1'><i style='margin-right:4px' class=\"fas fa-people-carry\"></i><span>Inyeccion</span></a></li>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
//            if (txtPermisos.contains("[85]")) {
                out.print("<li><a class=\"nav-link\" href='RecepcionMaterial?opc=11'><i style='margin-right:4px' class=\"fas fa-file-alt\"></i><span>Extrusion PVC</span></a></li>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
//            if (txtPermisos.contains("[85]")) {
                out.print("<li><a class=\"nav-link\" href='RecepcionMaterial?opc=11'><i style='margin-right:4px' class=\"fas fa-file-alt\"></i><span>Extrusion PP</span></a></li>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
//            if (txtPermisos.contains("[85]")) {
                out.print("<li><a class=\"nav-link\" href='RecepcionMaterial?opc=11'><i style='margin-right:4px' class=\"fas fa-file-alt\"></i><span>Peletizado</span></a></li>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
//            if (txtPermisos.contains("[85]")) {
                out.print("<li><a class=\"nav-link\" href='RecepcionMaterial?opc=11'><i style='margin-right:4px' class=\"fas fa-file-alt\"></i><span>Notas</span></a></li>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
            out.print("</ul>");
            out.print("</li>");
            out.print("</li>");
            out.print("<li class=\"menu-header\">Familias de Productos</li>");
            out.print("<li class=\"dropdown\">");
//            if (txtPermisos.contains("[86]")) {
                out.print("<a href=\"Familia_producto?opc=1\" class=\"nav-link\"><i class=\"fab fa-hubspot\"></i> <span>Catalogo Defectos</span></a>");
//            } else {
//                out.print("<li><a class=\"nav-link\" href='#'><i style='margin-right:4px' class='fas fa-ban'></i>No tiene permisos</a></li>");
//            }
            out.print("</ul>");
            ...
            out.print("<div style='text-align: center;\n"
                    ...
                    + "    box-shadow: -9px 0px 10px 9px #f9c827;"
                    + "'>"
                    + "<div class='divLogo'><a href=\"Inicio.jsp\"><img class='img_logo' src='Interfaz/Contenido/images/herramental.png' alt='Logo'></a></div></div>");
            out.print("</div>");
//</editor-fold>
