...
//</editor-fold>
            ...
            out.print("</div>");
            out.print("<div class='' style='width: 100%; text-align:center;'>");
            out.print("<button class='btn btn-secondary btn-lg' onclick='timer()'>Registrar</button>");
            out.print("</div>");
                        ...
                        for (int j = 0; j < arr_case.length; j++) {
                            ...
                            if (!obj_case[8].equals("N/A")) {
                                ...
                                if (cali == 0) {
                                    ...
                                    out.print("<a class='btn btn-secondary' data-toggle='tooltip' data-placement='top' title='Calificar' href='http://" + ipserver + ":" + port + "/" + app + "/Calificar_caso?opc=1&id_caso=" + obj_case[0] + "' target='_blank'><i class=\"fas fa-star\"></i></a>");
                                    out.print("</div>");
                                } else {
                                    out.print("<div class='col-12 mb-3' style='display: flex;'>");
                                    out.print("<div class='col-6'>");
...
//</editor-fold>
            ...
            out.print("</div>");
            out.print("<div class=''>");
            out.print("<button class='btn btn-light' style='border-radius: 4px;margin-right: 12px;' data-toggle='tooltip' data-placement='top' title='Ayuda' onclick='mostrarConvencion(4)'><i class=\"fas fa-info-circle\"></i></button>");
            out.print("<button class='btn btn-light' style='border-radius: 4px;margin-right: 12px;' data-toggle='tooltip' data-placement='top' title='Recargar' onclick='location.href=\"Support?opc=1\"'><i class=\"fas fa-sync-alt\"></i></button>");
            out.print("<button class='btn btn-secondary' style='border-radius: 4px;' data-toggle='tooltip' data-placement='top' title='Registrar Caso' onclick='mostrarConvencion(1)'><i class='fas fa-plus'></i></button>");
            out.print("</div>");
            out.print("</div>");
                        ...
                        for (int j = 0; j < arr_case.length; j++) {
                            ...
                            if (!obj_case[8].equals("N/A")) {
                                ...
                                if (Integer.parseInt(obj_case[19].toString()) == 0) {
                                    out.print("<button type='button' onclick=\"javascript:location.href='Support?opc=1&idSupport=" + idTemp + "'\" class='btn btn-warning btn-sm btn-icon' data-toggle='tooltip' data-placement='top' title='Solucionado sin calificar'><i class='fas fa-check'></i></button>");
                                } else {
                                    out.print("<button type='button' onclick=\"javascript:location.href='Support?opc=1&idSupport=" + idTemp + "'\" class='btn btn-success btn-sm btn-icon' data-toggle='tooltip' data-placement='top' title='Cerrado'><i class='fas fa-check'></i></button>");
                                }
                                out.print("</td>");
                            } else {
                                ...
                                out.print("<td align='center'>");
                                out.print("<button type='button' onclick=\"javascript:location.href='Support?opc=1&idSupport=" + idTemp + "'\" class='btn btn-info btn-sm btn-icon' data-toggle='tooltip' data-placement='top' title='Esperando solucion'><i class='fas fa-hourglass-start fa-spin'></i></button>");
                                out.print("</td>");
                            }
                            out.print("</tr>");
                            j = arr_case.length;
