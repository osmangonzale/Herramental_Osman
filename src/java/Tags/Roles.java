...
public class Roles extends TagSupport {
...
//</editor-fold>
        try {
            ...
            out.print("<h4>Tabla de Roles</h4>");
            ...
            if (lst_roles != null) {
                for (int i = 0; i < lst_roles.size(); i++) {
                    ...
                    if (Integer.parseInt(obj_rol[3].toString()) == 1) {
                        ...
                        out.print("</td>");
                        out.print("<td align='center'>");
                        out.print("<button type='button' onclick='ActivarRol(" + obj_rol[0] + ")' class='btn btn-danger btn-sm btn-icon' style='width: 28px;' data-toggle='tooltip' data-placement='top' title='Activar Rol'><i class='fas fa-times'></i></button>");
                        out.print("</td>");
                        out.print("</tr>");
                    }
                }
