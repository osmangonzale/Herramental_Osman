...
public class MaquinaJpaController implements Serializable {
    ...
    public List filtro_general(String parametro) {
        ...
        try {
            Query q = etm.createNativeQuery("CALL `sp_mvm_c_ult_movimiento_filtrado`('" + parametro + "')");
    ...
    public List ConsultaMaquinas_U_movimientos() {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `sp_mvm_c_ult_movimiento_todas_maquinas`()");
            List resultados = q.getResultList();
            em.getTransaction().commit();
            em.clear();
            em.close();
    ...
    public boolean ModificarEstadoMaquina(int id_maquina, int estado, String justicacion) {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `sp_mqn_m_estado_maquina`('" + id_maquina + "','" + estado + "','" + justicacion + "')");
            int resultado = q.executeUpdate();
            em.getTransaction().commit();
            em.clear();
            em.close();
