...
public class HerramentalJpaController implements Serializable {
    ...
    public boolean RegistroHerramental(String codigo, String descripcion, int tipo, String maquina, String Usuario_registro) {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `sp_hrm_r_herramental`('" + codigo + "','" + descripcion + "','" + tipo + "','" + maquina + "','" + Usuario_registro + "')");
    ...
    public boolean ModificarHerramental(int id_herramental, String codigo, String descripcion, int tipo, String maquina, String Usuario_registro) {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `sp_hrm_m_herramental`('" + id_herramental + "','" + codigo + "','" + descripcion + "','" + tipo + "','" + maquina + "','" + Usuario_registro + "')");
            int resultado = q.executeUpdate();
            em.getTransaction().commit();
            em.clear();
            em.close();
    ...
    public boolean cambiarEstado_Herramental(int id_herramental, int estado) {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `sp_hrm_m_herramental_cambiarEstado`('" + id_herramental + "','" + estado + "')");
            int resultado = q.executeUpdate();
            em.getTransaction().commit();
            em.clear();
            em.close();
